...
def address(first_recycling_bin)
  return first_recycling_bin["address"]
end
...
def borough(first_recycling_bin)
  return first_recycling_bin["borough"]
end
...
def all_keys(first_recycling_bin)
  first_recycling_bin.each_key do |key|
    puts "#{key}"
  end
end
...
def all_data(first_recycling_bin)
  first_recycling_bin.each_value do |value|
    puts "#{value}"
  end
end
...
def key_and_data(first_recycling_bin)
  first_recycling_bin.each do |key, value|
